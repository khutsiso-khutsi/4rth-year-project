...
namespace admin.Repository
{
    public class AdminRepository
    {
     ...
     => _dataAccess.GetDashboardCounts();
        ...
        // ── MEDICAL CONDITIONS ────────────────────────────────────────
        public List<MedicalCondition> GetAllConditions() => _dataAccess.GetAllConditions();
        ...
        // ── ALLERGY CATEGORIES ────────────────────────────────────────
        public List<AllergyCategory> GetAllAllergyCategories() => _dataAccess.GetAllAllergyCategories();
        ...
        // ── ALLERGIES ─────────────────────────────────────────────────
        public List<Allergy> GetAllAllergies() => _dataAccess.GetAllAllergies();
        ...
        public List<MedicationCategory> GetAllMedicationCategories() => _dataAccess.GetAllMedicationCategories();
        ...
        // ── MEDICATIONS ───────────────────────────────────────────────
        public List<Medication> GetAllMedications() => _dataAccess.GetAllMedications();
